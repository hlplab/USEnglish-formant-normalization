...
```{r exp-procedure, echo=FALSE, fig.cap="(ref:exp-procedure)", out.width='40%', fig.align='center'}
include_graphics("figures-to-import/response-grid.png")
```
...
#include_graphics(figure_file("Figure3.png"))
```
