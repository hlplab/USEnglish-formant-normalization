...
```{r spectrograms, fig.align='center', fig.cap="(ref:spectrograms)", fig.height=base.heigh*2, echo=FALSE}
...
```{r spectrograms1, echo=FALSE, fig.align='center', out.width='90%', fig.cap="(ref:spectrograms)"}
