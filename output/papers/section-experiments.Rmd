...
Experiment 1a employed *hVd* word recordings by one adult female talker of a Northeastern dialect (spoken in central Connecticut) from a phonetically annotated database of L1-US English vowel productions [@xie-jaeger2020]. Specifically, we used all nine recordings of each of the eight *hVd*-words---*heed*, *hid*, *head*, *had*, *hut*, *odd*, *who'd*, *hood* [the use of "hut" and "odd" rather than "hud" and "hod" follows @assmann2008; but see @hillenbrand1995].
